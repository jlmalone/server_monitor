...
- **Name:** `com.servermonitor.redo-https`
- **Port:** 3443
- **Command:** `node /Users/jlmalone/WebstormProjects/redo-web-app/https-server.js`
...
<dict>
    <key>Label</key>
    <string>com.servermonitor.SERVICE_NAME</string>
    ...
    <string>/Users/jlmalone/ios_code/server_monitor/logs/SERVICE_NAME.log</string>
    <key>StandardErrorPath</key>
    <string>/Users/jlmalone/ios_code/server_monitor/logs/SERVICE_NAME.error.log</string>
</dict>
</plist>
```
...
```bash
# Load a service
launchctl load ~/Library/LaunchAgents/com.servermonitor.SERVICE.plist

# Unload a service  
launchctl unload ~/Library/LaunchAgents/com.servermonitor.SERVICE.plist
