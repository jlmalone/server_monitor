...
///
/// The supervised healthcheck publishes a fresh snapshot periodically. This model is read-only — the
...
struct DarkmeshStatus: Codable, Equatable {
    ...
    /// Schema 3+ is fail-closed: a missing supervisor verdict is not healthy.
