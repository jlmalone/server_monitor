...
describe('Service Migration', () => {
  ...
  describe('plist parsing', () => {
    it('parses existing plist correctly', () => {
      ...
      writeFileSync(join(sourceDir, 'vision.salient.test-app.plist'), plistContent);
      ...
      assert.ok(result.includes('vision.salient.test-app'), 'Should extract identifier');
    });
