...
describe('plist-from-json library', () => {
  ...
  describe('extractShortName()', () => {
    it('should extract last component of identifier', () => {
      assert.strictEqual(extractShortName('vision.salient.my-app'), 'my-app');
    });
    ...
    it('should handle multiple dots', () => {
      assert.strictEqual(extractShortName('vision.salient.example-https'), 'example-https');
    });
  });
  ...
  describe('generatePlistFromService()', () => {
    ...
    it('configures logging paths correctly', () => {
      const service = {
        identifier: 'vision.salient.web-server',
        path: '/app',
